...
export const AddApiKeyDialog = ({ isOpen, onOpenChange }: AddApiKeyDialogProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Thêm API Key Gemini mới</DialogTitle>
          <DialogDescription>
            Đặt tên để dễ dàng nhận biết và dán API Key của bạn vào đây.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 pt-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ví dụ: Key cá nhân" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Dán API Key của bạn ở đây" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={addKeyMutation.isPending}>
                {addKeyMutation.isPending ? "Đang thêm..." : "Thêm Key"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
