...
import { AlertCircle, Mic, Trash2, Loader2 } from "lucide-react";
...
export const ClonedVoiceList = () => {
  const { data: voices, isLoading, isError, error } = useQuery({
  ...
  return (
    <Card>
      <CardHeader><CardTitle>Danh sách Giọng nói đã Clone</CardTitle><CardDescription>Các giọng nói tùy chỉnh của bạn.</CardDescription></CardHeader>
      <CardContent>
